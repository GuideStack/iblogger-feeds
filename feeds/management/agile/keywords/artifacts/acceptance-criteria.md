...
flowchart TD
    A["គ្មានលក្ខខណ្ឌច្បាស់លាស់<br/>(No Clear Criteria)"]:::danger --> B["ស្មាន 'រួចហើយ' តាមការមើល<br/>(Guess What 'Done' Means)"]:::danger
    B --> C["ផល​ផលិតខុសពីការរំពឹង<br/>(Output Misses Expectation)"]:::danger
    C --> D["ធ្វើឡើងវិញ ខូចខាតធនធាន<br/>(Rework, Wasted Effort)"]:::danger
...
flowchart LR
    A["សរសេរលក្ខខណ្ឌច្បាស់<br/>(Write Clear Criteria)"]:::ok --> B["២ ស្រទាប់ គ្មានសណ្តែក<br/>(2 Layers, No Nuts)"]:::ok
    B --> C["នំត្រូវតាមរំពឹង<br/>(Cake Meets Expectation)"]:::success
...
* **លទ្ធផល៖** អ្នក​សាកល្បង (QA) ដឹង​ពិតប្រាកដ​ថា ត្រូវ​សាកអ្វី អ្នក​អភិវឌ្ឍ​ន៍ដឹងថា ត្រូវ​កសាងអ្វី ហើយមុខងារ​បាន​ឆ្លងកាត់​ដោយ​គ្មាន​ការ​ខ្វែងគំនិត​ឡើយ។
...
flowchart LR
    A["Story មាន AC ច្បាស់<br/>(Story Has Clear AC)"]:::ok --> B["QA ដឹងត្រូវសាកអ្វី<br/>(QA Knows What to Test)"]:::ok
    B --> C["ឆ្លងកាត់គ្មានខ្វែងគំនិត<br/>(Passes, No Disputes)"]:::success
...
flowchart LR
    A["កិច្ចសន្យាស្រពិចស្រពិល<br/>(Vague Contract)"]:::danger --> B["ភាគីស្មានខុសគ្នា<br/>(Each Side Assumes)"]:::danger
    B --> C["ជម្លោះ លុបកិច្ចសន្យា<br/>(Dispute, Cancelled)"]:::danger
...
flowchart LR
    A["គ្មានលក្ខខណ្ឌប្រគល់<br/>(No Handover Criteria)"]:::danger --> B["ម៉ៅការ​ស្មាន 'ហើយ'<br/>(Contractor Assumes Done)"]:::danger
    B --> C["ទឹកលេច ភ្លើងខូច<br/>(Defects Found)"]:::danger
    C --> D["វិវាទច្បាប់ ប្រគល់យឺត<br/>(Legal Dispute, Delay)"]:::danger
...
flowchart LR
    A["លក្ខណៈវិនិច្ឆ័យច្បាស់លាស់<br/>(Defined Criteria)"]:::ok --> B["ប្រសិទ្ធភាព ៩៥% ផលរំខានទាប<br/>(Efficacy & Safety Met)"]:::ok
    B --> C["អនុម័ត សុវត្ថិភាពអ្នកជំងឺ<br/>(Approved, Patients Safe)"]:::success
...
**សិស្ស៖** គាត់វាស់ខ្នាត​របស់​អតិថិជននីមួយ ៗ ព្រោះ​ម្នាក់ ៗ ខុសគ្នា។
...
flowchart TD
    A["User Story<br/>(The Story)"]:::process --> B["សរសេរ AC មុនការអភិវឌ្ឍន៍<br/>(Write AC First)"]:::process
    B --> C["ច្បាស់លាស់ និងសាកល្បងបាន<br/>(Clear & Testable)"]:::process
    C --> D["ឯកភាពជាមួយម្ចាស់ផលិតផល<br/>(Agreed with PO)"]:::process
    D --> E["'រួចហើយ' ច្បាស់លាស់<br/>(Unambiguous 'Done')"]:::success
    E --> F["ផ្ទៀងផ្ទាត់ AC + DoD<br/>(Verify AC + DoD)"]:::process
