...
នៅស្រុកមួយ មាន​ទន្លេវែងដ៏ធំ ហូរកាត់ភូមិមួយ ដែល​ធំ និង​ជ្រៅពេក មិន​អាចឆ្លងម្តង​បាន​ឡើយ។ វិស្វករម្នាក់ឈ្មោះ **ដារ៉ា (Dara)** បាន​សិក្សាទន្លេ​នេះ ហើយដឹងថា ការ​ព្យាយាមឆ្លងវា​ក្នុង​ពេល​តែ​មួយ គឺ​មហន្តរាយ។ គាត់ក៏រចនា​ប្រព័ន្ធ **ទ្វារទប់ទឹក (lock-gates)** បែងចែកទន្លេវែង​ជា​ផ្នែក ៗ ដែល​អាច​ធ្វើ​ដំណើរ​បាន។ ទូកនីមួយ ៗ ឆ្លងកាត់ផ្នែកមួយម្តង ៗ ៖ ចូលផ្នែកទីមួយ បិទទ្វារ លៃកម្រិតទឹក រួចបើកទ្វារ​ទៅ​ផ្នែកបន្ទាប់។
...
flowchart TD
    A["ចាត់ទុក Epic ជាកិច្ចការតែមួយ<br/>(Treat Epic as One Task)"]:::danger --> B["ធ្វើទាំងមូលក្នុងពេលតែមួយ<br/>(Build It All at Once)"]:::danger
    B --> C["Block យូរ ហានិភ័យខ្ពស់<br/>(Long Block, High Risk)"]:::danger
    C --> D["គ្មានគុណតម្លៃបញ្ជូនបាន<br/>(No Value Delivered)"]:::danger
...
flowchart LR
    A["បំបែកជាបន្ទប់ម្តងមួយ<br/>(Split by Room)"]:::ok --> B["ផ្ទះបាយ ➔ បន្ទប់ទឹក ➔ បន្ទប់គេង<br/>(One Room at a Time)"]:::ok
    B --> C["ប្រើបានភ្លាមរាល់ផ្នែក<br/>(Usable Each Stage)"]:::success
...
flowchart LR
    A["Epic ប្រព័ន្ធទូទាត់<br/>(Payment Epic)"]:::ok --> B["បំបែក៖ កាត ➔ QR ➔ សងវិញ<br/>(Split into Stories)"]:::ok
    B --> C["ទូទាត់កាតផ្តល់ចំណូលភ្លាម<br/>(Card Live, Revenue Now)"]:::success
...
flowchart LR
    A["បើក ៥០ សាខាព្រមគ្នា<br/>(Open All 50 at Once)"]:::danger --> B["ប្រព័ន្ធផ្គត់ផ្គង់ដួល<br/>(Supply Chain Collapse)"]:::danger
    B --> C["សាខាបើកដោយវឹកវរ<br/>(Chaotic Openings)"]:::danger
    C --> D["បាត់បង់អតិថិជន<br/>(Lost Customers)"]:::danger
...
flowchart LR
    A["បំបែកជាដំណាក់កាល<br/>(Phase the Migration)"]:::ok --> B["ទិន្នន័យ ➔ ប្រាក់ខែ ➔ វិស្សមកាល<br/>(One Phase at a Time)"]:::ok
    B --> C["ផ្លាស់ប្តូររលូន<br/>(Smooth Migration)"]:::success
...
flowchart LR
    A["បំបែកបេសកកម្មជាដំណាក់កាល<br/>(Phase the Mission)"]:::ok --> B["សាកម៉ាស៊ីន ➔ មនុស្សយន្ត ➔ គន្លង<br/>(Test, Robotic, Orbit)"]:::ok
    B --> C["បេសកកម្មសុវត្ថិភាព<br/>(Safe Crewed Mission)"]:::success
...
**សិស្ស៖** បើលោតម្តង ខ្ញុំប្រាកដ​ជា​លិច។ ឆ្លងម្តងមួយផ្នែកវិញ ទើបសុវត្ថិភាព។
...
flowchart TD
    A["Epic៖ ទន្លេវែងទាំងមូល<br/>(The Whole River)"]:::process --> B["កំណត់គោលដៅច្បាស់លាស់<br/>(Define Epic Goal)"]:::process
    B --> C["បំបែកជា Story បញ្ឈរ<br/>(Split Vertical Stories)"]:::process
    C --> D["រៀបលំដាប់តាមគុណតម្លៃ/ហានិភ័យ<br/>(Sequence by Value/Risk)"]:::process
    D --> E["បញ្ជូនម្តងមួយ Story<br/>(Deliver One Slice)"]:::success
    E --> F["Epic បញ្ចប់ដោយជឿជាក់<br/>(Epic Completed Safely)"]:::process
