...
```mermaid
%%{init: {'theme': 'dark', 'themeVariables': {'primaryColor': '#004d40', 'primaryBorderColor': '#00251a', 'primaryTextColor': '#ffffff', 'lineColor': '#e0e0e0', 'secondaryColor': '#1a237e', 'tertiaryColor': '#4a148c', 'background': '#1e1e1e', 'mainBkg': '#004d40', 'nodeBorder': '#00251a', 'clusterBkg': '#263238', 'titleColor': '#ffffff', 'edgeLabelBackground': '#263238'},
  'themeCSS': 'svg { background-color: #1e1e1e !important; padding: 1rem !important; border-radius: 8px !important; } text, tspan { fill: #ffffff !important; } .edgeLabel rect { fill: #1e1e1e !important; }'
}}%%
flowchart LR
    L([📚 LEARN<br>invest in<br>yourself])
    E([💰 EARN<br>create value,<br>be rewarded])
    R([🤝 RETURN<br>give back,<br>lift others])

    L -->|build capability| E
    E -->|build means| R
    R -.keep learning.-> L

    L --- L2([knowledge ·<br>skills · experience])
    E --- E2([value · money ·<br>reputation])
    R --- R2([mentor · teach ·<br>invest · give])

    style L fill:#4a148c,stroke:#12005e,color:#fff
    style E fill:#1b5e20,stroke:#003300,color:#fff
    style R fill:#1a237e,stroke:#0d47a1,color:#fff
    style L2 fill:#263238,stroke:#000,color:#fff
    style E2 fill:#263238,stroke:#000,color:#fff
    style R2 fill:#263238,stroke:#000,color:#fff
```
