...
**Type:** Early-stage startup working documents (draft)
**Status:** 🚧 Draft / internal

> A working hub for the team's operating documents — team structure, tasks, meeting records, product requirements, and partnerships. All personal names, emails, and partner/vendor names are anonymized to roles/placeholders.
...
> ⚠️ **Privacy note:** This is a `draft/` working folder. Keep real names, emails, phone numbers, bank details, and vendor contacts **out of these files** — store those in a private (non-published) tracker only.
