...
```mermaid
%%{init: {'theme': 'dark', 'themeVariables': {'primaryColor': '#1b5e20', 'primaryBorderColor': '#003300', 'primaryTextColor': '#ffffff', 'lineColor': '#e0e0e0', 'secondaryColor': '#1a237e', 'tertiaryColor': '#4a148c', 'background': '#1e1e1e', 'mainBkg': '#1b5e20', 'nodeBorder': '#003300', 'clusterBkg': '#263238', 'titleColor': '#ffffff', 'edgeLabelBackground': '#263238'},
...
flowchart TD
    ...
    subgraph F1 ["📚 1 · Knowledge"]
        ...
        K2([Understand the<br>market & customer])
    end

    subgraph F2 ["🛠️ 2 · Skill"]
        S1([Practice until<br>you can deliver])
        S2([Prove you can do it<br>reliably, not once])
    end
    ...
    subgraph F4 ["💼 4 · Choose a Problem"]
        P1([Spot a real, daily<br>problem people have])
        P2([Solve it → that's<br>the business])
    end
    ...
    style F3 fill:#1a237e,stroke:#0d47a1,color:#fff
    style F4 fill:#1b5e20,stroke:#003300,color:#fff
```
