...
graph TD
    A["🚀 ការលោតដ៏ឆ្ងាយរបស់អ៊ូឃុង (The Leap)"] --> B["🏔️ ឃើញសសរផ្កាឈូកប្រាំ (Local Perception)"]
    B --> C["✍️ សរសេរឈ្មោះ / គិតថាខ្លួនឈ្នះ (Overconfidence)"]
    C --> D["✋ បាតដៃរបស់ព្រះពុទ្ធ (System Boundary)"]
    D --> E["📉 ស្វែងយល់ពីដែនកំណត់ពិតប្រាកដ (Humility)"]
...
graph TD
    A["💻 ម៉ាស៊ីនផ្ទាល់ខ្លួន (Local Machine)"] --> B["✅ ដំណើរការល្អ (Works Locally)"]
    A --> C["✋ បរិស្ថាន Production ពិត (Production Environment)"]
    C --> D["❌ ប្រព័ន្ធគាំង (System Crashes)"]
...
សហគ្រិនម្នាក់ បង្កើតអាជីវកម្មលក់ផលិតផលមួយប្រភេទ ហើយទទួលបានការគាំទ្រយ៉ាងខ្លាំងពីមិត្តភក្តិ និងក្រុមគ្រួសារ (សសរទាំងប្រាំ)។ គាត់សន្និដ្ឋានភ្លាម ៗ ថា ផលិតផលនេះនឹងទទួលបានជោគជ័យទូទាំងប្រទេស ហើយសម្រេចចិត្តវិនិយោគទឹកប្រាក់យ៉ាងច្រើនដើម្បីពង្រីកអាជីវកម្មភ្លាម ៗ ។ គាត់ភ្លេចថា ទីផ្សារពិតប្រាកដ (បាតដៃព្រះពុទ្ធ) មានភាពស្មុគស្មាញ និងមានអាកប្បកិរិយាខុសគ្នាស្រឡះពីក្រុមអតិថិជនដំបូងរបស់គាត់។
...
graph LR
    A["🧐 1. បន្ថយការជឿជាក់<br/>លើសម្មតិកម្មដំបូង"] --> B["📝 2. ធ្វើតេស្តសាកល្បង<br/>នៅក្រៅតំបន់មានសុវត្ថិភាព"]
    B --> C["🤝 3. ស្វែងរកការវាយតម្លៃ<br/>ពីអ្នកក្រៅ (Feedback)"]
    C --> A
