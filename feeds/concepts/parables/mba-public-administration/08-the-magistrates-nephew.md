...
```mermaid
graph TD;
    A["Public Official (Magistrate)"] --> B{"Decision Making Framework"};
    B --> C["Private Duty (Family/Nepotism)"];
    B --> D["Public Duty (Impartiality/Competence)"];
    C -->|Conflict of Interest| E["Corruption & High Risk of Failure"];
    D -->|Ethical Governance| F["Best Outcome for Citizens"];
