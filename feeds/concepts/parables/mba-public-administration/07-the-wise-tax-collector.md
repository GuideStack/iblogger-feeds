...
```mermaid
graph LR;
    A["Individual Wealth (Taxes)"] -->|Pooled Together| B["Government Treasury"];
    B --> C["Public Goods & Infrastructure"];
    B --> D["National Security & Rule of Law"];
    B --> E["Education & Social Welfare"];
    C --> F["Increased Individual Prosperity"];
    D --> F;
    E --> F;
