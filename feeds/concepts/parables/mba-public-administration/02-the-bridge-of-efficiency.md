...
```mermaid
graph LR;
    A["Strict Bureaucracy"] -->|Prioritizes| B["Rules & Accountability"];
    C["Agile Administration"] -->|Prioritizes| D["Outcomes & Speed"];
    B -->|Can lead to| E["Goal Displacement / Paralysis"];
    D -->|Can lead to| F["Risk of Errors / Fraud"];
    E -.-> G["Effective Public Administration"];
    F -.-> G;
    G --> H["Balance of Control & Responsiveness"];
```
