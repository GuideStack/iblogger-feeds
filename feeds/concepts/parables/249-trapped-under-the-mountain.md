...
graph TD
    A["🐒 កម្លាំងធំ + ឧទ្ធច្ច<br/>(great power + ego)"] --> B["⚔️ បះបោរ បំផ្លាញឋានសួគ៌"]
    B --> C["🏔️ ជាប់ក្រោមភ្នំ ៥០០ ឆ្នាំ<br/>(humility & reflection)"]
    C --> D["🎯 ទទួលបេសកកម្ម (ធម្មយាត្រា)<br/>+ វិន័យ"]
    D --> E["🏆 ក្លាយជាវីរបុរសពិត<br/>(true hero)"]
...
graph TD
    A["🐒 ពូកែ តែ៖ ឧទ្ធច្ច គ្មានវិន័យ<br/>'ច្បាប់មិនពាក់ព័ន្ធនឹងខ្ញុំ'"] --> B["🏔️ គ្មាននរណាចង់ធ្វើការជាមួយ<br/>(ឃុំក្រោមភ្នំឧទ្ធច្ច)"]
    B --> C["🌱 រៀនវិន័យ + ភាពបន្ទាបខ្លួន"]
    C --> D["🏆 ទេពកោសល្យចេញផ្លែផ្កា"]
...
graph TD
    A["🏔️ រយៈពេលលំបាក<br/>(បរាជ័យ / បាត់ការងារ / ជំងឺ)"] --> B["😣 មានអារម្មណ៍ដូចទណ្ឌកម្ម"]
    B --> C["🧘 ឆ្លុះបញ្ចាំង + បន្ទាបខ្លួន"]
    C --> D["🎯 ងើបឡើងវិញ មានគោលដៅច្បាស់"]
...
graph LR
    A["💪 ទេពកោសល្យ<br/>(raw talent)"] --> B["🧘 + វិន័យ<br/>(discipline)"]
    B --> C["🎯 + បេសកកម្ម<br/>(mission)"]
    C --> D["🏆 ភាពអស្ចារ្យពិត<br/>(true greatness)"]
