...
graph TD
    A["👁️ អ្នកនិយាយការពិត<br/>(ស្តេចស្វា មើលឃើញឆ្អឹងស)"] --> B["😣 ការពិតមិនពិរោះស្ដាប់<br/>(Uncomfortable truth)"]
    B --> C["🙏 មនុស្សស្មោះត្រង់ មិនស្រួលចិត្ត<br/>(ព្រះថាង)"]
    C --> D["❌ ដាក់ទោសអ្នកនាំសារ<br/>(Banish the messenger)"]
    D --> E["💀 បិសាចឆ្នេញ ការពិតបាត់<br/>(The lie wins)"]
...
graph TD
    A["🙏 ប្រធានចិត្តល្អ<br/>ជឿតែអ្នកញញឹមផ្គាប់ផ្គុន"] --> B["🎭 អ្នកប្រឹក្សាក្លែងក្លាយ<br/>បានឡើងតំណែង"]
    B --> C["🤐 អ្នកនិយាយការពិត<br/>ស្ងៀមស្ងាត់ ឬលាឈប់"]
    C --> D["❌ ប្រធានសម្រេចចិត្តខុស<br/>ព្រោះគ្មានការពិតមកដល់"]
...
graph TD
    A["🔴 ដាក់ទោសអ្នករាយការណ៍<br/>bug / ហានិភ័យ"] --> B["🤐 គ្មាននរណាហ៊ានរាយការណ៍<br/>ដំណឹងអាក្រក់ទៀត"]
    B --> C["🌋 បញ្ហាកកកុញលាក់ខ្លួន<br/>រហូតក្លាយជាមហន្តរាយ"]
    C --> D["❌ ប្រព័ន្ធដួលរលំ<br/>ដោយគ្មានការព្រមានជាមុន"]
...
graph LR
    A["🧠 1. ភាពស្មោះត្រង់<br/>≠ ការវិនិច្ឆ័យ"] --> B["📨 2. កុំដាក់ទោស<br/>អ្នកនាំសារ"]
    B --> C["💔 3. ការអាណិត<br/>អាចជារបាំងបិសាច"]
    C --> D["⏳ 4. មើលលំនាំ<br/>តាមពេលវេលា"]
    D --> E["🔥 5. ភ្នែកមាស<br/>លត់ដំក្នុងភ្លើង"]
...
* **[244 The White Bone Demon & the Fiery Eyes](./244-the-white-bone-demon-and-the-fiery-eyes.md)** — ប៉ារ៉ាប៊ល់ដៃគូ៖ ផ្នែក «របាំងមុខ vs ខ្លួនពិត» នៃរឿងតែមួយ (the companion parable: the *masks vs. true self* half of the same story).
* **[78 The Seventy-Two Faces of Sun Wukong](../articles/78-the-seventy-two-faces-of-sun-wukong.md)** — អត្ថបទវិទ្យាសាស្ត្រ៖ ខ្សែបន្ទាត់ពីការសម្របខ្លួន ទៅភាពបាត់ខ្លួន (the science article on the adaptation spectrum).
* **[03 The Angel and Demon Dilemma](./03-angel-and-demon-dilemma.md)** — EQ និងការអានមនុស្សនៅពីក្រោយពាក្យសម្ដី (reading people beneath their words).
