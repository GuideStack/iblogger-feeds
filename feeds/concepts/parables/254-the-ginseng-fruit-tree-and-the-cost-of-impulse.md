...
graph TD
    A["⚙️ Legacy Code (Ginseng Tree)"] --> B["😡 លុបចោលដើម្បីសរសេរថ្មី (Rage Rewrite)"]
    B --> C["⚠️ បាត់បង់ Edge Cases / Bug ច្រើន"]
    C --> D["🛠️ ចំណាយពេលរាប់ខែជួសជុល (Remediation)"]
...
graph LR
    A["🛑 1. ច្បាប់ ២៤ ម៉ោង<br/>(24-Hour Rule)"] --> B["🔍 2. វាយតម្លៃតម្លៃសរុប<br/>នៃការស្តារឡើងវិញ (TCR)"]
    B --> C["🤝 3. ស្វែងរកការសម្របសម្រួល<br/>(Guanyin Dew)"]
    C --> A
