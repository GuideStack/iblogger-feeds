...
graph TD
    A["📏 គ្រូវាយក្បាល ៣ ដង រួចចងដៃទៅក្រោយ (Subtle Signal)"] --> B["👥 សិស្សដទៃ៖ យល់ថាជាការដាក់ទោស<br/>= ស្ដាប់តាមអក្សរ (Low Context)"]
    A --> C["🐒 អ៊ូឃុង៖ បកស្រាយសញ្ញាបង្កប់<br/>= ស្ដាប់ដោយសកម្ម (High Context)"]
    C --> D["🔑 ទៅជួបគ្រោងសម្ងាត់ពេលយប់<br/>(Secrets of 72 Transformations)"]
...
graph LR
    A["🧐 1. កុំផ្ដោតតែលើពាក្យសម្តី<br/>(Words are only 10%)"] --> B["🔍 2. សិក្សាពីបរិបទ និងកាយវិការ<br/>(Context & Subtext)"]
    B --> C["❓ 3. សួរសំណួរដើម្បីបញ្ជាក់សញ្ញា<br/>(Clarify the Knocks)"]
    C --> A
