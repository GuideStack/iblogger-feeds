...
graph TD
    A["🐒 កម្លាំងធំ ឥតព្រំដែន<br/>(immense power, no limit)"] --> B["⚔️ ឋានសួគ៌វាយក៏មិនឈ្នះ"]
    B --> C["👑 បន្ទះមាស (Golden Headband)<br/>= ការទទួលខុសត្រូវ"]
    C --> D["🎯 កម្លាំងធំ + ទិសដៅ + ព្រំដែន<br/>= វីរបុរសពិត"]
...
graph TD
    A["🐒 វិស្វករ 10x<br/>'ខ្ញុំពូកែ មិនបាច់ review'"] --> B["🛑 push ផ្ទាល់ production<br/>គ្មាន guardrails"]
    B --> C["💥 កំហុសតែមួយ<br/>បំផ្លាញប្រព័ន្ធទាំងមូល"]
    C --> D["✅ ដំណោះស្រាយ៖ review + CI/CD gates<br/>(បន្ទះមាស)"]
...
graph TD
    A["👑 អ្នកដឹកនាំ៖ 'ខ្ញុំជាចៅហ្វាយ<br/>មិនបាច់មាននរណាត្រួតពិនិត្យ'"] --> B["🚫 គេចពី board / audit / feedback"]
    B --> C["📉 សម្រេចចិត្តខុស គ្មាននរណាហ៊ានហាម


    "]
    C --> D["❌ អង្គភាពទាំងមូលរងគ្រោះ"]
