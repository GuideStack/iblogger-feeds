...
graph TD
    A["🐒 ស្តេចស្វា (Sun Wukong):<br/>ភ្នែកមាសមើលឃើញការពិត"] --> B["👁️ មើលទម្លុះរបាំងមុខ<br/>(Sees through the mask)"]
    C["💀 បិសាចឆ្អឹងស (White Bone Demon):<br/>ប្រែមុខ ៣ ដងបញ្ឆោត"] --> D["🎭 មុខស្អាត ខាងក្រៅ<br/>ឆ្អឹងស ខាងក្នុង"]
    B --> E["⚖️ ការពិត vs របាំងមុខ<br/>(Truth vs. Mask)"]
    D --> E
...
graph LR
    A["👁️ 1. មើល 'ខ្លឹមសារ'<br/>មិនមែន 'របាំងមុខ'"] --> B["🔁 2. ពិនិត្យឥរិយាបថ<br/>តាមពេលវេលា មិនមែនពាក្យ"]
    B --> C["💎 3. រក្សា 'មុខពិត' ខ្លួនឯង<br/>ដើម្បីកុំក្លាយជាបិសាច"]
    C --> A
