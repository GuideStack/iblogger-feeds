...
graph TD
    A["🐒 ទេពកោសល្យ + មហិច្ឆតា"] --> B["🏷️ ងារធំ តែទទេ<br/>'មហាសិទ្ធិស្មើឋានសួគ៌'"]
    B --> C["😤 ដឹងថាជាល្បិចបន្ធូរអារម្មណ៍<br/>(senses the tokenism)"]
    C --> D["💥 បះបោរកាន់តែខ្លាំង<br/>(rebels harder)"]
...
graph TD
    A["🏷️ 'Head of ...' (ងារធំ)<br/>គ្មានប្រាក់ខែ/ក្រុម/អំណាច"] --> B["😒 បុគ្គលិកដឹងថាជាងារទទេ"]
    B --> C["📉 ការលើកទឹកចិត្តធ្លាក់ចុះ"]
    C --> D["🚪 លាឈប់ ដោយអារម្មណ៍ត្រូវបោក"]
