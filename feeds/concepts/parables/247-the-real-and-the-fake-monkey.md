...
graph TD
    A["🐒 ស្វាពិត (Real Monkey)"] --> C["❓ មុខ កម្លាំង ការចងចាំ<br/>ដូចគ្នាបេះបិទ"]
    B["🐵 ស្វាក្លែង (Fake Monkey)"] --> C
    C --> D["⚖️ ព្រះក៏បែងចែកមិនបាន<br/>(Even gods can't tell)"]
    D --> E["🪷 មានតែ 'ព្រះ' ដែលមើលឃើញ 'ចិត្ត'<br/>(Only Buddha sees the heart)"]
...
graph TD
    A["🐵 អ្នកចម្លង៖ យកលទ្ធផល<br/>(copies the output)"] --> B["✅ មើលទៅដូចគ្នា ដំបូង"]
    B --> C["❓ ត្រូវដោះស្រាយបញ្ហាថ្មី<br/>ឬពន្យល់ 'ហេតុអ្វី'"]
    C --> D["❌ បង្ហាញថាគ្មានការយល់ដឹងពិត"]
...
graph TD
    A["📱 ផ្ទៃក្លែងរបស់គេ<br/>(their curated surface)"] --> C["⚖️ ការប្រៀបធៀបមិនយុត្តិធម៌"]
    B["😔 ខាងក្នុងពិតរបស់យើង<br/>(our real inside)"] --> C
    C --> D["❌ មានអារម្មណ៍ថាមិនគ្រប់គ្រាន់"]
    D --> E["✅ ផ្តោតលើ 'ចិត្ត' និងផ្លូវដំណើរពិតរបស់ខ្លួន"]
...
graph LR
    A["🪷 1. ស្គាល់ 'ហេតុអ្វី'<br/>របស់ខ្លួនឯង"] --> B["⏳ 2. បង្ហាញភាពជាប់លាប់<br/>តាមពេលវេលា"]
    B --> C["🌱 3. រីកលូតលាស់<br/>ដែលក្លែងធ្វើមិនបាន"]
    C --> A
