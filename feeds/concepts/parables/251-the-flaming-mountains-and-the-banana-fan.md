...
graph TD
    A["🔥 ភ្នំភ្លើង (the obstacle)"] --> B["💪 កម្លាំង/ហោះកាត់<br/>= បរាជ័យ"]
    A --> C["🪭 ផ្លិតក្លែង (fake fan)<br/>= ភ្លើងឆេះខ្លាំងជាង"]
    A --> D["🧠 យុទ្ធសាស្ត្រ + ផ្លិតពិត + តស៊ូ<br/>= ឆ្លងផុត"]
...
graph TD
    A["🔥 គម្រោងយឺត (the fire)"] --> B["🪭 ផ្លិតក្លែង៖ បន្ថែមមនុស្ស<br/>(Brooks's Law)"]
    B --> C["📉 កាន់តែយឺត (fire hotter)"]
    A --> D["🧠 ផ្លិតពិត៖ កាត់ scope<br/>ឬផ្លាស់ប្ដូរ process"]
    D --> E["✅ ឆ្លងផុត"]
...
graph LR
    A["🛑 1. ឈប់ប្រើកម្លាំង<br/>បើវាមិនដំណើរការ"] --> B["🔍 2. រកមូលហេតុ<br/>+ ឧបករណ៍ត្រឹមត្រូវ"]
    B --> C["🔁 3. តស៊ូ ដោយផ្លាស់ប្ដូរវិធី<br/>(persist + adapt)"]
    C --> A
