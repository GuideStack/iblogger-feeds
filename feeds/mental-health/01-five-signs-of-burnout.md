...
```mermaid
graph LR
    A["Sustained Stress"] --> B["Early Warning Signs"]
    B --> C["Ignored or<br/>Unaddressed"]
    C --> D["🔴 Full Burnout"]
    B --> E["Early Intervention"]
    E --> F["✅ Recovery"]
...
```mermaid
graph TD
    A["🔴 Chronic Stress"] --> B["Cortisol overload"]
    B --> C["Poor sleep quality"]
    C --> D["Low energy &<br/>body aches"]
    D --> A
    D --> E["⚠️ Chronic Exhaustion"]
    E --> F["✅ Break the cycle:<br/>Track sleep,<br/>reduce 1 stressor,<br/>add recovery practice"]
...
```mermaid
graph TD
    A["Unmet expectations &<br/>persistent obstacles"] --> B["Sense of purpose<br/>erodes"]
    B --> C["🔴 Cynicism sets in"]
    C --> D["Roll eyes<br/>at meetings"]
    C --> E["Don't care<br/>about outcomes"]
    C --> F["Sarcastic<br/>about the job"]
    D --> G["✅ Fix:<br/>Reconnect with purpose,<br/>set boundaries,<br/>seek small wins"]
    E --> G
    F --> G
...
```mermaid
graph TD
    A["🔴 Poor Focus"] --> B{"Root Cause?"}
    B -->|Too many meetings| C["Block deep<br/>work time"]
    B -->|Sleep deprivation| D["Fix sleep<br/>schedule"]
    B -->|Anxiety| E["Talk to<br/>manager"]
    B -->|Physical health| F["Exercise,<br/>nutrition"]
...
```mermaid
graph TD
    A["🔴 Overwhelming stress"] --> B["Brain numbs<br/>emotional responses"]
    B --> C["⚠️ Emotional Detachment"]
    C --> D["Don't celebrate<br/>team wins"]
    C --> E["Feel like<br/>an outsider"]
    C --> F["Skip social<br/>events"]
    D --> G["✅ Fix:<br/>Talk to someone,<br/>attend one social<br/>event,<br/>seek professional help"]
    E --> G
    F --> G
...
```mermaid
graph TD
    A["🔴 Burnout &<br/>chronic stress"] --> B["Focus shifts to<br/>failures, not wins"]
    B --> C["⚠️ Confidence erodes"]
    C --> D["Avoid code reviews"]
    C --> E["Feel like a<br/>fraud"]
    C --> F["Simple problems<br/>feel impossible"]
    D --> G["✅ Fix:<br/>Document wins,<br/>seek feedback,<br/>practice self-compassion"]
    E --> G
    F --> G
...
```mermaid
graph LR
    A["Week 1–2:<br/>Notice signs,<br/>take action"] --> B["Week 3–4:<br/>Small improvements,<br/>better focus"]
    B --> C["Month 2–3:<br/>Sleep improves,<br/>energy increases"]
    C --> D["Month 4–6:<br/>Enjoy work again,<br/>feel like yourself"]
    D --> E["Month 6+:<br/>✅ New habits stick,<br/>burnout feels distant"]
