...
```mermaid
graph LR
    A["ព្រៃឈើ<br/>(Forest)"] --> B["កាប់<br/>(Extract)"]
    B --> C["ធ្យូង<br/>(Charcoal)"]
    C --> D["លក់<br/>(Sell)"]
    D --> E["ប្រាក់<br/>រហ័ស"]
    E --> F["គ្មានព្រៃ<br/>គ្មានទឹកភ្លៀង"]
    F --> G["ដី<br/>ហួតហែង"]
    G --> H["ភូមិ<br/>ត្រូវវាង"]
...
```mermaid
graph TD
    A["ដើមឈើ<br/>(Tree)"] --> B["ដំណាំ<br/>ថ្មី ២"]
    B --> C["ចំណាញ<br/>ស្លឹក"]
    C --> D["ជី<br/>(Compost)"]
    D --> E["ដី<br/>មានជីជាតិ"]
    E --> A

    F["ដើមឈើ<br/>ស្លាប់"] --> G["អុស<br/>(Deadwood)"]
    G --> H["ផ្កាំ<br/>(Ash)"]
    H --> I["ជីដី<br/>(Soil Fertilizer)"]
    I --> E

    J["ដើម<br/>ចិញ្ចឹម"] --> K["លក់<br/>ដល់ភូមិ"]
...
```mermaid
graph LR
    A["Linear<br/>Economy"] --> B["Take<br/>(យក)"]
    B --> C["Make<br/>(ធ្វើ)"]
    C --> D["Waste<br/>(បោះចោល)"]
    D --> E["Resource<br/>Depletion"]

    F["Circular<br/>Economy"] --> G["Reduce<br/>(កាត់បន្ថយ)"]
    G --> H["Reuse<br/>(ប្រើឡើងវិញ)"]
    H --> I["Recycle<br/>(ចាក់ទៅ)"]
    I --> J["Regenerate<br/>(ដុះឡើងវិញ)"]
    J --> F
