...
```mermaid
graph TD
    A["ខេត្ត<br/>ជនបទ"] --> B["គ្មានសាលា<br/>ក្នុង ២០ គីម"]
    B --> C["កុមារ<br/>ដើរ ៤ ម៉ោង"]
    C --> D["ភាគច្រើន<br/>ឈប់ទៅ"]
    D --> E["អក្ខរកម្ម<br/>ទាប (Low Literacy)"]
    E --> F["វដ្តនៃ<br/>ភាពក្រីក្រ"]
...
```mermaid
graph LR
    A["គ្រួសារ<br/>សំបូរ"] --> B["ថ្លៃ<br/>$150/ខែ"]
    B --> C["ចំណូល<br/>ពេញ (Full Revenue)"]
    C --> D["ផ្ដល់<br/>ឥតគិតថ្លៃ ៤០ កន្លែង"]
    D --> E["កុមារ<br/>ភូមិ"]

    E --> F["SROI<br/>$1 → $8"]
    C --> G["ប្រាក់ខែ<br/>គ្រូ"]
    C --> H["ថ្លៃ<br/>សំណង់"]
...
```mermaid
graph TD
    A["Triple<br/>Bottom Line"] --> B["People<br/>(ការ អប់រំ)"]
    A --> C["Planet<br/>(ការ ប្រើ ស្ថានីយ)"]
    A --> D["Profit<br/>(ការ ចំណេញ)"]

    E["B-Corp<br/>Certification"] --> F["B Impact<br/>Assessment"]
    F --> G["Workers<br/>Community<br/>Environment<br/>Governance"]

    H["Theory of<br/>Change"] --> I["Input<br/>(ចំណូល)"]
    I --> J["Output<br/>(អ្នករៀន)"]
    J --> K["Outcome<br/>(អក្ខរកម្ម)"]
    K --> L["Impact<br/>(SROI)"]
